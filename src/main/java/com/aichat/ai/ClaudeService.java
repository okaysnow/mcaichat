...
public class ClaudeService implements AIService {
    ...
    public CompletableFuture<String> generateResponse(String message, List<ChatMessage> context, String personality, int maxLength, String username) {
        return CompletableFuture.supplyAsync(() -> {
            try {
                String apiKey = ModConfig.claudeApiKey;
                ...
                if (responseCode == 200) {
                    ...
                    br.close();
                    System.err.println("Claude API Error: " + error.toString());
    ...
    private JsonObject buildRequestBody(String message, List<ChatMessage> context, String personality, int maxLength, String username) {
        ...
        body.addProperty("model", ModConfig.claudeModel);
        body.addProperty("max_tokens", maxLength * 2);
        body.addProperty("system", getSystemPrompt(personality, maxLength, username));
    ...
    public boolean isConfigured() {
        String key = ModConfig.claudeApiKey;
