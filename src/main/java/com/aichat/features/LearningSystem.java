...
public class LearningSystem {
     ...
     * Set player nickname
     * @param playerName Player name
     * @param nickname Preferred nickname
     */
     ...
     * Get player nickname
     * @param playerName Player name
     * @return Nickname or original name
     */
    ...
    /**
     * Set custom fact about a player
     * @param playerName Player name
     * @param key Fact key
    ...
    /**
     * Build global facts context for AI
     * @return Global facts string
     */
    ...
    /**
     * Get total number of interactions across all players
